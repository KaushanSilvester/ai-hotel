    ...
    <>
      <style>{`
        ...
        .nav-link {
          ...
          text-decoration: none; transition: color 0.15s; padding: 4px 0;
        ...
        .nav-username {
          ...
          background: rgba(255,255,255,0.07); padding: 6px 12px;
        ...
        .nav-btn-outline:hover { color: #fff; border-color: rgba(255,255,255,0.35); background: rgba(255,255,255,0.06); }
        .nav-btn-primary {
        ...
        .logout-btn {
          font-size: 13.5px; font-weight: 600; color: #fca5a5;
      ...
      <nav className="navbar">
        <div className="navbar-left">
          ...
          {token && (
            <>
              <Link to="/" className={`nav-link ${location.pathname === "/" ? "active" : ""}`}>Rooms</Link>
